export default async function handler(req, res) {
  ...
  try {
    ...
    const [
      ...
      fetchSchedule(today),
      fetch(`https://api.the-odds-api.com/v4/sports/baseball_mlb/odds/?apiKey=${apiKey}&regions=us&markets=h2h,spreads,totals,h2h_h1&oddsFormat=american&regions=us`),
