...
| **Should remain authoritative?** | Too new to say; recommended Phase 8 candidate (`docs/IMMUTABLE_PIPELINE.md` §12) is deciding its relationship to `authoritative.json` once a real consumer exists |
