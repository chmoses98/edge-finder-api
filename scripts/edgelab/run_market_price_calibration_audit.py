...
def closing_contract_rows(rows):
    """One row per contract: the settled+priced CLOSING-quote observation. This is the primary dataset for every headline/family/bucket/partition table in this report."""
