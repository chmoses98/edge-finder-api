...
# Repo root: resolve from this file's location regardless of working directory
...
def test_requested_date_is_passed_to_mlb_url():
    ...
    api_content = open(os.path.join(_REPO_ROOT, 'api', 'slate.js')).read()
...
def test_pitchers_api_has_no_cache_headers():
    api_content = open(os.path.join(_REPO_ROOT, 'api', 'pitchers.js')).read()
